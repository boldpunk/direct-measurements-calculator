...
export const api = {
  ...
  updateOutsourceExpense: (orderId, id, patch) => request(`/api/orders/${orderId}/outsourcing/${id}`, { method: 'PATCH', body: patch }),
  ...
  updateSalaryExpense: (orderId, id, patch) => request(`/api/orders/${orderId}/salaries/${id}`, { method: 'PATCH', body: patch }),
